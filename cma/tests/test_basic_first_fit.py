...
class TestBasicFirstFit(unittest.TestCase):
    ...
    def test_req_highest_list(self):
        work_memory = [(0x00A00000, 0x000C0000), (0x00B00000,
                                                  0x000C0000), (0x00C00000, 0x000C0000)]
        req = 0x000D0000
        index = 0
        search = first_fit(work_memory, req, index)
        self.assertEqual(search, None)
    ...
    def test_req_choose_last_index(self):
        work_memory = [(0x00A00000, 0x000C0000), (0x00B00000,
                                                  0x000C0000), (0x00C00000, 0x000D0000)]
        req = 0x000D0000
        index = 0
        search = first_fit(work_memory, req, index)
    ...
    def test_req_choose_middle_index(self):
        work_memory = [(0x00A00000, 0x000C0000), (0x000B0000,
                                                  0x000D0000), (0x00C00000, 0x000C0000)]
        req = 0x000D0000
    ...
    def test_req_choose_last_index_keep(self):
        work_memory = [(0x00A00000, 0x000C0000), (0x00B00000,
                                                  0x000C0000), (0x00C00000, 0x000E0000)]
        req = 0x000D0000
        index = 0
        search = first_fit(work_memory, req, index)
    ...
    def test_req_choose_first_fit_len(self):
        work_memory = [(0x00A00000, 0x000D0A0), (0x00B00000,
                                                 0x000D000A), (0x00C00000, 0x000D0000)]
        req = 0x000D0000
        index = 0
        len_work_memory = len(work_memory)
        search = first_fit(work_memory, req, index)
    ...
    def test_req_choose_first_fit_index(self):
        work_memory = [(0x00A00000, 0x000D0A00), (0x00B00000,
                                                  0x000D000A), (0x00C00000, 0x000D0000)]
        req = 0x000D0000
        index = 0
        search = first_fit(work_memory, req, index)
